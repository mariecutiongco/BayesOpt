---
title: "Attempt at Bayesian Optimization for Nanotpography exploration version 2"
output: html_notebook
edits: Edited the run to increase number of experiments, as Bjorn suggested
---

This notebook shows results for optimizing Topography with respect to osteogenesis
...
Import the datasets that we need and process them as needed.
Note that we changed the columns used for x so that we dont use the angles anymore!
```{r message=FALSE, warning=FALSE}
#data import
